...
Karşılıklı Gol Olur veya 2.5 Üst Gol Olur
Hayır 2.25 Evet 1.55
Toplam Kornerler
...
def test_parse_odds_pdf_text() -> None:
...
def test_extract_real_pdf_text() -> None:
    ...
    assert "Real Betis" in text
    assert "Getafe" in text
    assert "Maç Sonucu" in text
...
def test_parse_real_odds_pdf() -> None:
